...
func TestGetCanonicalPath(t *testing.T) {
	...
	testCases := []struct {
		...
		{users["alice"], "", "."},
		{users["bob"], ".", "."},
		{users["alice"], "libonomy", "libonomy"},
		{users["bob"], "libonomy/app/config", "libonomy/app/config"},
		{users["alice"], "libonomy/../test", "test"},
		{users["bob"], "libonomy/../..", ".."},
		{users["bob"], "libonomy/.././../test", ".." + RootFolder + "test"},
		{users["alice"], "a/b/../c/d/..", "a/c"},
		{usr, "~/libonomy/test/../config/app/..", "~" + usr.HomeDir + RootFolder + "libonomy/config"},
		{users["bob"], "~/libonomy/test/../config/app/..", users["bob"].HomeDir + RootFolder + "libonomy/config"},
		{users["alice"], RootFolder + "libonomy", RootFolder + "libonomy"},
		{users["bob"], RootFolder + "libonomy/app/config", RootFolder + "libonomy/app/config"},
		{users["alice"], RootFolder + "libonomy/../test", RootFolder + "test"},
	}
